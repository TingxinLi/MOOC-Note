...
public class QuickSort1 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Compare num in sorting: " + qs1.CountQsort(t1));
		int[] t2 = {8, 10, 1, 9, 7, 2, 6, 3, 5, 4};
		System.out.println("Compare num in sorting: " + qs1.CountQsort(t2));
		**/
		...
		System.out.println("Compare num is " + qs1.CountQsort(testArray));
