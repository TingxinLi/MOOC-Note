...
public class KdTree {
    ...
    private String subTra(Node node){
        ...
        StringBuffer sb = new StringBuffer();
        sb.append("(" + node.getPoint().x() + " , " + node.getPoint().y() + ") Level: " + node.getLevel() + " ");
    ...
    **/
    ...
    public static void main(String[] args)  {
	    Point2D p = new Point2D(0.55, 0.7);
	    Point2D p2 = new Point2D(0.5, 0.75);
	    Point2D p3 = new Point2D(0.75, 0.5);
	    Point2D p4 = new Point2D(0.4, 0.4);
	    Point2D p5 = new Point2D(0.3, 0.45);
	    Point2D p6 = new Point2D(0.35, 0.25);
	    Point2D p7 = new Point2D(0.5, 0.75);
        ...
        Point2D p8 = new Point2D(1.0, 1.0);
        System.out.println(kt.contains(p7));
        System.out.println(kt.contains(p8));
        System.out.println(kt.contains(p3));
        
        RectHV rect = new RectHV(0.45, 0.3, 1.0, 1.0);
        for (Point2D point : kt.range(rect)) {
        	System.out.println(point);
        };
        
        System.out.println("----------------------");
        RectHV rect2 = new RectHV(0.0, 0.0, 1.0, 1.0);
        for (Point2D point : kt.range(rect2)) {
        	System.out.println(point);
        };
        
        System.out.println("----------------------");
        System.out.println(kt.nearest(p8));
        
        KdTree kt2 = new KdTree();
        System.out.println(kt2.isEmpty());
        System.out.println(kt2.size());
        System.out.println(kt2.nearest(p8));
